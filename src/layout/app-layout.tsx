...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Prompts', path: '/prompts', entity: 'prompt', service: AccessServiceEnum.PROJECT, icon: FiMessageSquare },
    { name: 'Requests', path: '/requests', entity: 'request', service: AccessServiceEnum.PROJECT, icon: FiMail },
    {
      name: 'Responses',
      path: '/responses',
      entity: 'response',
