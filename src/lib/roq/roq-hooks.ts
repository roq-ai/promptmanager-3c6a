...
export function useApiCallFindMany<
...
>(
  ...
  const key = JSON.stringify(['useApiCallFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.api_call.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useApiCallCount<T extends Prisma.api_callCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.api_callCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useApiCallCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.api_call.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useApiCallFindManyWithCount<
  T extends Prisma.api_callFindManyArgs,
  R extends { data: GetFindResult<Prisma.$api_callPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.api_callFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useApiCallFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.api_call.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useApiCallFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useApiCallFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.api_call.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePromptFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePromptFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.prompt.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePromptCount<T extends Prisma.promptCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.promptCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['usePromptCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.prompt.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePromptFindManyWithCount<
  T extends Prisma.promptFindManyArgs,
  R extends { data: GetFindResult<Prisma.$promptPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.promptFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePromptFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.prompt.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePromptFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePromptFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.prompt.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRequestFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRequestFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.request.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRequestCount<T extends Prisma.requestCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.requestCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useRequestCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.request.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRequestFindManyWithCount<
  T extends Prisma.requestFindManyArgs,
  R extends { data: GetFindResult<Prisma.$requestPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.requestFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRequestFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.request.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useRequestFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useRequestFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.request.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useResponseFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useResponseFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.response.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useResponseCount<T extends Prisma.responseCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.responseCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useResponseCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.response.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useResponseFindManyWithCount<
  T extends Prisma.responseFindManyArgs,
  R extends { data: GetFindResult<Prisma.$responsePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.responseFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useResponseFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.response.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useResponseFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useResponseFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.response.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
